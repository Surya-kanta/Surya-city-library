...
<head>
    ...
    <title>Edit Author - Surya City Library</title>
...
<body>
    ...
    <form action="" method="post">
        <div class="container">
            ...
            <button type="submit" name="update_author" class="btn-primary">Update Author</button>
        </div>
    </form>
...
<?php
	if(isset($_POST['update_author']))
	{
		...
		$query_run = mysqli_query($connection,$query);
        if ($query_run) {
            echo "<script>alert('Author update successfully!'); window.location.href='admin_manage_auth.php';</script>";
        } else {
            echo "<script>alert('Error update author');</script>";
        }
	}
?>
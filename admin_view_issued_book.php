...
<head>
    ...
    <title>Issued Books - Surya City Library</title>
    ...
    <form>
        <table class="table-bordered" width="900px" style="text-align: center">
            ...
            <?php
                ...
                $query = "select issued_books.book_name,issued_books.author_name,issued_books.book_no,users.name from issued_books left join users on issued_books.student_id = users.id where issued_books.status = 1";
            ...
            <tr>
                ...
                <td><button class="btn-primary" name=""><a href="return_book.php?bn=<?php echo $row['book_no'];?>">Return</a></button></td>
            </tr>
            <?php
				}
			?>

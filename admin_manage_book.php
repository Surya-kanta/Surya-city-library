...
<head>
    ...
    <title>Manage Books - Surya City Library</title>
...
<body>
    ...
    <table class="table-bordered" width="900px" style="text-align: center">
        ...
        <tr>
            ...
            <td><button class="btn-primary" name=""><a href="admin_edit_book.php?bn=<?php echo $row['book_no'];?>">Edit</a></button></td>
            <td><button class="btn-primary" name=""><a href="admin_delete_book.php?bn=<?php echo $row['book_no'];?>">Delete</a></button></td>
        </tr>
        <?php
			}
		?>
